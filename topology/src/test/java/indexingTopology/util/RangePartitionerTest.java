...
public class RangePartitionerTest {
    ...
    public void getSkewnessFactor() throws Exception {
        ...
        RangePartitioner manager = new RangePartitioner(4, config.NUMBER_OF_INTERVALS, ballToBinMapping, histogram);
    ...
    public void getRepartitionPlanTest() throws Exception {
        ...
        RangePartitioner manager = new RangePartitioner(10, config.NUMBER_OF_INTERVALS, ballToBinMapping, histogram);
